...
public class AddEventActivityNew extends AppCompatActivity implements View.OnClickListener, Toolbar.OnMenuItemClickListener, FabricInitializer{


    private Toolbar mToolbar;
    private EditText mStartDateEditText, mStartDateTimeEditText,
                    mEndDateEditText, mEndDateTimeEditText,
                    mEventNameEditText, mEventTypeEditText,mEventRecurrenceEditText, mEventPlaceEditText,
                    mEventDescriptionEditText;

    private PlaceAutocompleteFragment mPlaceAutocompleteFragment;

    private Button mAddEventButton;

    private String startDate, endDate, startTime, endTime, eventName, eventType, eventRecurrence,eventPlace, eventDescription;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Date mPassedDateStart = (Date) getIntent().getSerializableExtra("Date");
        EventSerializable mPassedEventSerializable = (EventSerializable)  getIntent().getSerializableExtra("event");
        if(mPassedEventSerializable == null){
            Log.e("AddEventActivityNew","EVENTSERIALIZABLE IS NULL!!");
            mPassedEventSerializable = new EventSerializable();
        }
        Log.d("AddNewEvent","Event passed: "+mPassedEventSerializable.toString());

        mToolbar = (Toolbar) findViewById(R.id.toolbar);
        mToolbar.setNavigationIcon(R.drawable.ic_clear_white_24dp);
        mToolbar.setTitle("Dodaj wydarzenie");
        ...
        //String passedDateString = DateUtils.dateToString(mPassedDateStart);
        ...
        mStartDateEditText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                args.putString("activity", "AddEventActivityNew");
