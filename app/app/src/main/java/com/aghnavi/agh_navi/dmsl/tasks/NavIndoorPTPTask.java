...
public class NavIndoorPTPTask extends AsyncTask<Void, Void, String> {
    ...
    public NavIndoorPTPTask(NavRouteListener l, Context mapNavigationActivity, String source, String destination) {
        this.mListener = l;
        ...
        try {
            ...
            j.put("pois_from", source);
            j.put("pois_to", destination);
    ...
    protected String doInBackground(Void... params) {
        try {
            ...
            String response = NetworkUtils.downloadHttpClientJsonPost(AnyplaceAPI.getNavRouteUrl(), json_req);
