...
public class SensorsStepCounter implements SensorEventListener, SensorsMain.IAccelerometerListener {
    ...
    public interface IStepListener {
        void onNewStep(float value);
    }

    private List<IStepListener> stepListeners = new ArrayList<>(1);
    ...
    public SensorsStepCounter(Context context, SensorsMain sensorsMain) {
        ...
        if (!myPackageManager.hasSystemFeature(PackageManager.FEATURE_SENSOR_STEP_COUNTER)) {
    ...
    public void pause() {
        if (isPositioningOn) {
            ...
            if (softwareSensor == null) {
                ...
                sensorsMain.removeListener(this);
            }
        }
    }
