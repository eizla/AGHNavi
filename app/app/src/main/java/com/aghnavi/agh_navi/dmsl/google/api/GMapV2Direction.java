...
//TODO: Using old Google Directions API + old HTTP Apache (which I fixed for good dependency but stil deprecated) - fix it later
public class GMapV2Direction {

    public final static String API_KEY = "AIzaSyBlxWZczCyfXQMcZKrb-EDFvLKP-PoAk8w";
